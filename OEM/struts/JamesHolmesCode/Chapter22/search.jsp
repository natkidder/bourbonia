...
<s:form id="search" action="/search">

<table>
<tr>
<td align="right"><s:message key="label.search.name"/>:</td>
<td><h:inputText id="name" value="#{searchForm.name}"/></td>
</tr>
<tr>
<td></td>
<td>-- or --</td>
...
<tr>
<td align="right"><s:message key="label.search.ssNum"/>:</td>
<td><h:inputText id="ssNum" value="#{searchForm.ssNum}"/> (xxx-xx-xxxx)</td>
</tr>
<tr>
<td></td>
