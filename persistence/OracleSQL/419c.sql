/*
example of a cursor-for loop without the defined cursor.  Opposes 418d.
*/
set echo off
...
begin
  ...
  for v_reg in (select region, headcount from regions2) loop
...
begin
  ...
  for v_reg in (select * from regions2 order by region) loop
