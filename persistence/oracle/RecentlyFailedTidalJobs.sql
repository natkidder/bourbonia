...
jr.JobRun_EstTime, jr.JobRun_Time, jr.JobRun_Duration, 
jr.JobRun_Status, um.UsrMst_FullName
...
and jm.JobMst_Name in (
  ...
  and (jr.JobRun_Status <> 101 and jr.JobRun_Status <> 11) 
  and lower(jm.JobMst_Name) like '%edf%wn%p %'
  and SYSDATE - jr.JobRun_EstTime < 1.5 AND SYSDATE - 
jr.JobRun_EstTime > 0 
  )
order by jm.JobMst_Name, jmc.JobMst_Name, jr.JobRun_EstTime;
