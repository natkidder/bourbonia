...
/**
 * Manages persistence for the {@link ContactCategory} typesafe enumeration.
 */
public class ContactCategoryType implements UserType {
     ...
     * @return <code>true</code> iff both represent the same ContactCategory type.
     * @throws ClassCastException if x or y isn't a {@link ContactCategory}.
     */
    public boolean equals(Object x, Object y) {
        // We can compare instances, since ContactCategory are immutable singletons
        return (x == y);
    }
     ...
     *
     * @return {@link ContactCategory}, the actual type returned
     * by {@link #nullSafeGet}.
     */
     ...
     * @return the retrieved {@link ContactCategory} value, or <code>null</code>.
        ...
        throws SQLException
    {
        ...
        try {
            return ContactCategory.valueOf(name);
        }
        catch (IllegalArgumentException e) {
            throw new HibernateException("Bad ContactCategory value: " + name, e);
        }
    }
     ...
     * @param value the ContactCategory value to write.
        ...
        throws SQLException
    {
        String name = null;
        if (value != null)
            name = ((ContactCategory)value).toString();
