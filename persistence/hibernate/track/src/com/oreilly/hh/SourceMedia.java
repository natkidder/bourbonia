...
public enum SourceMedia  {
	...
	*/
	...
	/**
	* Enum constructors are always private since they can only be accessed through the enumeration mechanism.
	*
	* @param description human readable description of the source for the audio, by which it is presented in the user interface.
	*/
	...
	*
	* @return the human-readable description by which this value is identified in the user interface.
	*/
