...
public class HelloServiceLocator extends org.apache.axis.client.Service implements com.tutorial.HelloService {
    ...
    private java.lang.String Hello_address = "http://tempuri.org/WebServiceTutorial/services/Hello";
    ...
    public com.tutorial.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.tutorial.HelloSoapBindingStub _stub = new com.tutorial.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.tutorial.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                com.tutorial.HelloSoapBindingStub _stub = new com.tutorial.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://tutorial.com", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://tutorial.com", "Hello"));
        }
