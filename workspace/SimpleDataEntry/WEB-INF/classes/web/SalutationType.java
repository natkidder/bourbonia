...
/**
 * Manages persistence for the {@link Salutation} typesafe enumeration.
 */
public class SalutationType implements UserType {
     ...
     * @return <code>true</code> iff both represent the same Salutation type.
     * @throws ClassCastException if x or y isn't a {@link Salutation}.
     */
    public boolean equals(Object x, Object y) {
        // We can compare instances, since Enumeration's are immutable singletons
        return (x == y);
    }
     ...
     *
     * @return {@link Salutation}, the actual type returned
     * by {@link #nullSafeGet}.
     */
     ...
     * @return the retrieved {@link Salutation} value, or <code>null</code>.
        ...
        throws SQLException
    {
        ...
        try {
            return Salutation.valueOf(name);
        }
        catch (IllegalArgumentException e) {
            throw new HibernateException("Bad Salutation value: " + name, e);
        }
    }
     ...
     * @param value the Salutation value to write.
        ...
        throws SQLException
    {
        String name = null;
        if (value != null)
            name = ((Salutation)value).toString();
