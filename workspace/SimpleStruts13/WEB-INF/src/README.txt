to run, run the build.xml and then do http://localhost:8080/BasicStrutsExample/PersonalData.do

You may need to change the build.xml to reflect the local Tomcat configuration
