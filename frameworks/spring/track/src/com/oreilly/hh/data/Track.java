...
@Table(name="Track")
@NamedQueries({
	@NamedQuery(name="com.oreilly.hh.data.tracksNoLongerThan", query="from Track as track where track.playTime <= :length"),
	@NamedQuery(name="com.oreilly.hh.data.trackByName", query="from Track as track where track.title = :name")
	})
