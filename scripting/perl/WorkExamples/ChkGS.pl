...
$DSN = "Provider=SQLOLEDB.1;Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=EDF_GS;Data Source=EDFVWN01P;";

##my $SQL = "SELECT Oname FROM tbl_onames WHERE Oname LIKE '135%'";
my $SQL = <<EOF;
SELECT a.ONAME as TSKey, b.orowid, b.ovalue12, b.ovalue16, b.ovalue17
