...
if (scalar(@ARGV) < 3 or $ARGV[0] eq "--help") {
  print "ChkObs.pl: arg1: server, arg2: database, arg3: TS Key (w/ wildcards), arg4: filename prefix\n";
  exit 1;
}
...
my $ColList = <<EOF;
'',n.OID, n.OName, n.ODependents, n.OComponents, o.FormulaText
EOF
...
AND n.oname LIKE '$tskey' and o.FormulaText like '%+%'
EOF
