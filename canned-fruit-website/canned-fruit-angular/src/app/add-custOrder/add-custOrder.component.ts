import { Component, ChangeDetectionStrategy, ChangeDetectorRef, OnInit, WritableSignal, signal } from '@angular/core';
...
@Component({
    ...
    templateUrl: './add-custOrder.component.html',
    styleUrls: ['./add-custOrder.component.css'],
    standalone: true,
    imports: [MatTableModule, MatSortModule, CommonModule, ReactiveFormsModule, RouterModule],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class AddCustOrderComponent implements OnInit {
    ...
    disabledFirstSubmit: WritableSignal<boolean> = signal(false);
    ...
    async onSubmitMyForm() {
        ...
        // TODO: Enable submit button to add items after regular order form is created
        this.disabledFirstSubmit.set(true);
    }
    get cntItems() {
...
presidents: string[] = ['Washington', 'Adams', 'Jefferson', 'Madison', 'Monroe']; /////////
