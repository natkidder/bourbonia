// processes the request to add a stock rating from an analyst
// adds the rating, then sends the request back to RatingsForm.jsp to display the new model of the data
