...
mvn clean dependency:copy-dependencies
  mvn clean dependency:purge-local-repository   # to start over
mvn clean compile
mvn clean validate
mvn clean package
mvn spring-boot:run
...
## PostgreSql
### resources
https://github.com/springframeworkguru/spring-boot-postgress-example/blob/master/src/main/resources/application.properties
### settings
...
#### PEM server
  * host: localhost
  * user name: postgres
  * password: postgres or admin
  * port: 5433
  * If it does not come up, start the Windows Postgresql service