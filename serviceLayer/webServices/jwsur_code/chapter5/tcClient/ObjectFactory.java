...
public class ObjectFactory {
    ...
    private final static QName _F2C_QNAME = new QName("http://tc.ch05/", "f2c");
    private final static QName _C2FResponse_QNAME = new QName("http://tc.ch05/", "c2fResponse");
    private final static QName _C2F_QNAME = new QName("http://tc.ch05/", "c2f");
    private final static QName _F2CResponse_QNAME = new QName("http://tc.ch05/", "f2cResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tc.ch05/", name = "f2c")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tc.ch05/", name = "c2fResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tc.ch05/", name = "c2f")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tc.ch05/", name = "f2cResponse")
