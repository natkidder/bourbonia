...
public class ObjectFactory {
    ...
    private final static QName _GetTimeAsElapsed_QNAME = new QName("http://tsd.ch02/", "getTimeAsElapsed");
    private final static QName _GetTimeAsElapsedResponse_QNAME = new QName("http://tsd.ch02/", "getTimeAsElapsedResponse");
    private final static QName _GetTimeAsStringResponse_QNAME = new QName("http://tsd.ch02/", "getTimeAsStringResponse");
    private final static QName _GetTimeAsString_QNAME = new QName("http://tsd.ch02/", "getTimeAsString");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tsd.ch02/", name = "getTimeAsElapsed")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tsd.ch02/", name = "getTimeAsElapsedResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tsd.ch02/", name = "getTimeAsStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tsd.ch02/", name = "getTimeAsString")
