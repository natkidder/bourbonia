...
public class ObjectFactory {
    ...
    private final static QName _GetFibs_QNAME = new QName("http://ejb.ch06/", "getFibs");
    private final static QName _Fib_QNAME = new QName("http://ejb.ch06/", "fib");
    private final static QName _GetFibsResponse_QNAME = new QName("http://ejb.ch06/", "getFibsResponse");
    private final static QName _FibResponse_QNAME = new QName("http://ejb.ch06/", "fibResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ejb.ch06/", name = "getFibs")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ejb.ch06/", name = "fib")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ejb.ch06/", name = "getFibsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ejb.ch06/", name = "fibResponse")
