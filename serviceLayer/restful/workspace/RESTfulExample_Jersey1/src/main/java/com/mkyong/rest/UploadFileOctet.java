...
public class UploadFileOctet {
    ...
    @Consumes(MediaType.APPLICATION_OCTET_STREAM)
		...
		String uploadedFileLocation = "c://nat//tmp//golf.pdf";
    ...
    @Consumes(MediaType.APPLICATION_OCTET_STREAM)
         public Response uploadAttachment3(@DefaultValue("golf.pdf") @QueryParam("attachmentName") String attachmentName, InputStream attachmentInputStream) {
